...
#        self.assertNotRegex(respon, "kosong")
    ...
    def test_josuansef_UAS_DS(self):
        from Chapter02.JosuansefPardede_1184091_UAS_DS import Josuansef1184091_Producer,Josuansef1184091_Consumer
        threadjosuaproducer = Josuansef1184091_Producer("Thread utama ", 2,5,5,'josuanseff')
        threadjosuaconsumer = Josuansef1184091_Consumer("Thread baca file ", 1,'josuanseff')
        threadjosuaconsumer.start()
        threadjosuaproducer.start()
        threadjosuaconsumer.join()
        threadjosuaproducer.join()
        respon=self.readfile('./Chapter02/josuanseff.txt')